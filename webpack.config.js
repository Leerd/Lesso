...
module.exports = {
    entry: {               //точка(и) входа
        app: path.join(__dirname, 'Routing', 'main'), // __dirname - 'Это абсолютный путь к файлу
        vendors: path.join(__dirname, 'Routing', 'vendors'),
    },
    ...
    plugins: [
        ...
        new HtmlWebpackPlugin({
            template: path.join(__dirname, 'Routing', 'index.html'),
